      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue width100 cursonPointer basic_details" data-table-name="motor_vehicle_claim" >
              <div class="icon">
                <img src="../public/assets/icons/Motor-Vehicle-Claim.png" style="width: 40px;height: 40px;">
              </div>
              <h4>Motor Vehicle Claim</h4>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue width100 cursonPointer basic_details" data-table-name="life_insurance_claim" >
              <div class="icon">
                <img src="../public/assets/icons/Life-Insurance.png" style="width: 40px;height: 40px;">
              </div>
              <h4>Life Insurance Claim</h4>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange width100 cursonPointer basic_details" data-table-name="health_insurance">
              <div class="icon">
                <img src="../public/assets/icons/Health-Insurance.png" style="width: 40px;height: 40px;">
              </div>
